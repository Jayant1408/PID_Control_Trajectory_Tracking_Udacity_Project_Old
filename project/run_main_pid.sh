...
WIN_CARLA_EGG=""
if [[ -f "/mnt/c/Users/jayan/Downloads/CARLA_0.9.9.4/WindowsNoEditor/PythonAPI/carla/dist/carla-0.9.9-py3.7-win-amd64.egg" ]]; then
  WIN_CARLA_EGG="/mnt/c/Users/jayan/Downloads/CARLA_0.9.9.4/WindowsNoEditor/PythonAPI/carla/dist/carla-0.9.9-py3.7-win-amd64.egg"
elif [[ -f "/mnt/c/Users/jayan/Downloads/CARLA_0.9.13/WindowsNoEditor/PythonAPI/carla/dist/carla-0.9.13-py3.7-win-amd64.egg" ]]; then
...
if [[ -n "${WIN_CARLA_EGG}" ]]; then
  ...
  mkdir -p "${WIN_TMP_DIR}"
  cp -f "$(pwd)/simulatorAPI.py" "${WIN_TMP_DIR}/simulatorAPI.py" || true
